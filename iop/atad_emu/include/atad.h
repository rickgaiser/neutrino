...
/* These are used with the dir parameter of sceAtaExecCmd().  */
...
#define I_ata_device_dma_transfer         I_sceAtaExecCmd // Backward-compatibility
#define I_sceAtaExecCmd                   DECLARE_IMPORT(9, sceAtaExecCmd)
