...
| Module | Description |
|--------|-------------|
| smap_udpfs_ioman.irx | Full UDPFS: registers iomanX "udpfs:" device with file operations |
| smap_udpfs_fhi.irx | FHI variant: uses pre-opened handles for game boot via BREAD/BWRITE |
| smap_udpfs_bd.irx | Block device only: uses BREAD/BWRITE/GETSTAT subset, registers BDM "udp" device |

### iomanX Interface (smap_udpfs_ioman.irx)
...
### Block Device Interface (smap_udpfs_bd.irx)
